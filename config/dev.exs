...
config :shopify_app, ShopifyAppWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:shopify_app, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:shopify_app, ~w(--watch)]}
  ]
...
config :shopify_app, ShopifyAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/shopify_app_web/router\.ex$"E,
      ~r"lib/shopify_app_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
